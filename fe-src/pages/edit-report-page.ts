				...
				try {
					...
					if (respuesta !== "ok") {
						...
						messageComp.textContent =
							"No se pudo editar la publicacion, intenta mas tarde!";
						setTimeout(() => {
							Router.go("/mis-reports");
						}, 3000);
						...
						messageComp.style.display = "inherit";
						messageComp.textContent = "Publicacion editada!";
						setTimeout(() => {
							Router.go("/mis-reports");
						}, 3000);
					}
			...
			async function deleteReport(petId) {
				try {
					...
					if (respuesta !== "ok") {
						messageComp.style.display = "inherit";
						messageComp.textContent =
							"No se pudo eliminar la publicacion, intenta mas tarde!";
						setTimeout(() => {
							Router.go("/mis-reports");
						}, 3000);
						...
						messageComp.style.display = "inherit";
						messageComp.textContent = "Publicacion eliminada!";
						setTimeout(() => {
							Router.go("/mis-reports");
						}, 3000);
					}
